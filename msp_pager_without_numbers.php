...
//if(!empty($_GET['blog_id']) && $criteria['blog_id'] == $_GET['blog_id'] && (!empty($_GET['pager']) > 0)) {
	...
	echo '<li>';
		switch_to_blog($blog_id); 
				...
				echo '<div class="msp-content"><a href="' . get_post_permalink() . '" title="' . $arr_post[$i]['post_title'] . '">' . $arr_post[$i]['post_title'] . '</a>';
